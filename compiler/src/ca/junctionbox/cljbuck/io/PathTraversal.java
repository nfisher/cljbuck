...
public class PathTraversal extends SimpleFileVisitor<Path> {
    ...
    private ChannelOutput<Object> out;
        ...
        private PathTraversal(final String pattern, final ChannelOutput<Object> out) {
            this.out = out;
            this.matcher = FileSystems.getDefault().getPathMatcher("glob:" + pattern);
        }

        public static PathTraversal create(final String pattern, final ChannelOutput<Object> out) {
